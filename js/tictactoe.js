...
function placeXOrO(squareNumber) {
    ...
    function computersTurn() {
        ...
        while(!success) {
            //A random number 0 and 8 is selected
...
//This function parse the selectedSquares array to search for win conditions.
...
function drawWinLine(coordX1, coordY1, coordX2, coordY2) {
    ...
    function animateLineDrawing() {
        ...
        if (x1 <= 2 && y1 <= y2) {
            ...
            if (x < x2) { x += 10; }
            //This condition adds to the previous end y point.
            if (y < y2) { y += 10; }
    ...
    //This line disallows clicking while the win sound is plaing
    disableClick();
...
function resetGame() {
    ...
    //This reserts our array so it is empty and we can start over.
    selectedSquares = [];
}